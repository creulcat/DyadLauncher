...
const messages = defineMessages({
	openingApp: {
		...
		defaultMessage: 'Opening Dyad Launcher',
	},
	whyUseApp: {
		id: 'modal.open-in-app.why-use',
		defaultMessage: 'Why use the Dyad Launcher',
	},
	benefitLaunch: {
	...
	openingAutomatically: {
		...
		defaultMessage: 'The Dyad Launcher will open automatically...',
	},
	getApp: {
		id: 'modal.open-in-app.get-app',
		defaultMessage: 'Get Dyad Launcher',
	},
})
