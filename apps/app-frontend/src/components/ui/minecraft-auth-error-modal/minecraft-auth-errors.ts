...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so Dyad Launcher cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in Dyad Launcher',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Restart Dyad Launcher after waiting',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so Dyad Launcher cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Try signing in to Dyad Launcher again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'Dyad Launcher could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart Dyad Launcher and try signing in again',
			'Check that your internet connection is working',
			'Allow Dyad Launcher through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that Dyad Launcher recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
