...
export type AppEvent = { tag: "loading", value: LoadingPayload } | { tag: "process", value: ProcessPayload } | { tag: "instance", value: InstancePayload } | { tag: "instance_groups_changed", value: InstanceGroupsChangedPayload } | { tag: "instance_bulk_update_progress", value: InstanceBulkUpdateProgressPayload } | { tag: "install_job", value: InstallJobSnapshot } | { tag: "command", value: CommandPayload } | { tag: "warning", value: WarningPayload } | { tag: "log", value: LogPayload }
...
export type InstallJobKind = { tag: "create_instance" } | { tag: "create_modpack_instance" } | { tag: "import_instance" } | { tag: "import_modrinth_app" } | { tag: "duplicate_instance" } | { tag: "install_existing_instance" } | { tag: "install_pack_to_existing_instance" }
